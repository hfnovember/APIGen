...
/*
        ...
        Sample call for API/Producttypes/SearchByField:

            API/Producttypes/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Producttypes::$allFields as $classField) {
        ...
        $objects = Producttypes::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Producttypes::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Producttypes/SearchByField";
