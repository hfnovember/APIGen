...
/*
        ...
        Sample call for API/Unittypes/Create:

            API/Unittypes/Create?ID...&Name...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/Unittypes.php");
        $object = new Unittypes($_POST["ID"], $_POST["Name"]);
        $result = Unittypes::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Unittypes::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Unittypes/Create";
