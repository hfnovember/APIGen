...
/*
        ...
        Sample call for API/Users/SearchByField:

            API/Users/SearchByField?Fields=...Values=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Users::$allFields as $classField) {
                if ($field == $classField) {
                    $exists = true;
                    break;
                }   
        ...
        $objects = Users::searchByFields($assocArray);
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Users/SearchByField";
