...
/*
        ...
        Sample call for API/Userlevels/GetByID:

            API/Userlevels/GetByID?UserLevelID...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: UserLevelID (int), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        $object = Userlevels::getByID($_POST["UserLevelID"]);
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Userlevels/GetByID";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: UserLevelID (int), SessionID (String)";
