...
/*
        ...
        Sample call for API/_old_storage_type/SearchByField:

            API/_old_storage_type/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (_old_storage_type::$allFields as $classField) {
        ...
        $objects = _old_storage_type::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . _old_storage_type::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_storage_type/SearchByField";
