...
/*
        ...
        Sample call for API/_old_product_quantities/GetSize:

            API/_old_product_quantities/GetSize?SessionID=...
...
;
        $result = _old_product_quantities::getSize();
        if ($result !== false) {
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_product_quantities/GetSize";
