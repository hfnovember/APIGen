...
/*
        ...
        Sample call for API/Invoiceproducts/Create:

            API/Invoiceproducts/Create?ID...&InvoiceID...&ProductID...&Quantity...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: ID (int), InvoiceID (int), ProductID (int), Quantity (int), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/Invoiceproducts.php");
        $object = new Invoiceproducts($_POST["ID"], $_POST["InvoiceID"], $_POST["ProductID"], $_POST["Quantity"]);
        $result = Invoiceproducts::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Invoiceproducts::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Invoiceproducts/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: ID (int), InvoiceID (int), ProductID (int), Quantity (int), SessionID (String)";
	...
	if (!isset($_POST["InvoiceID"]) || $_POST["InvoiceID"] == "") die(json_encode($JSON_INVALID_PARAMS));
