...
/*
        ...
        Sample call for API/Invoiceproducts/SearchByField:

            API/Invoiceproducts/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Invoiceproducts::$allFields as $classField) {
        ...
        $objects = Invoiceproducts::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Invoiceproducts::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Invoiceproducts/SearchByField";
