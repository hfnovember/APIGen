...
/*
        ...
        Sample call for API/_old_recipe_ingredients/SearchByField:

            API/_old_recipe_ingredients/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (_old_recipe_ingredients::$allFields as $classField) {
        ...
        $objects = _old_recipe_ingredients::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . _old_recipe_ingredients::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_recipe_ingredients/SearchByField";
