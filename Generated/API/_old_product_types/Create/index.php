...
/*
        ...
        Sample call for API/_old_product_types/Create:

            API/_old_product_types/Create?Id...&Product_type_name...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: Id (int), Product_type_name (String), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/_old_product_types.php");
        $object = new _old_product_types($_POST["Id"], $_POST["Product_type_name"]);
        $result = _old_product_types::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (_old_product_types::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_product_types/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: Id (int), Product_type_name (String), SessionID (String)";
	...
	if (!isset($_POST["Product_type_name"]) || $_POST["Product_type_name"] == "") die(json_encode($JSON_INVALID_PARAMS));
