...
/*
        ...
        Sample call for API/Suppliers/SearchByField:

            API/Suppliers/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Suppliers::$allFields as $classField) {
        ...
        $objects = Suppliers::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Suppliers::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Suppliers/SearchByField";
