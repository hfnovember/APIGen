...
/*
        ...
        Sample call for API/Unittypes/SearchByField:

            API/Unittypes/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Unittypes::$allFields as $classField) {
        ...
        $objects = Unittypes::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Unittypes::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Unittypes/SearchByField";
