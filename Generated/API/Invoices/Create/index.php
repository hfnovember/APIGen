...
/*
        ...
        Sample call for API/Invoices/Create:

            API/Invoices/Create?ID...&CustomerID...&InvoiceProductsID...&Tax...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: ID (int), CustomerID (int), InvoiceProductsID (int), Tax (double), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/Invoices.php");
        $object = new Invoices($_POST["ID"], $_POST["CustomerID"], $_POST["InvoiceProductsID"], $_POST["Tax"]);
        $result = Invoices::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Invoices::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Invoices/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: ID (int), CustomerID (int), InvoiceProductsID (int), Tax (double), SessionID (String)";
	...
	if (!isset($_POST["CustomerID"]) || $_POST["CustomerID"] == "") die(json_encode($JSON_INVALID_PARAMS));
	if (!isset($_POST["InvoiceProductsID"]) || $_POST["InvoiceProductsID"] == "") die(json_encode($JSON_INVALID_PARAMS));
	if (!isset($_POST["Tax"]) || $_POST["Tax"] == "") die(json_encode($JSON_INVALID_PARAMS));
