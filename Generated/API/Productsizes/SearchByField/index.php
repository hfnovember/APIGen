...
/*
        ...
        Sample call for API/Productsizes/SearchByField:

            API/Productsizes/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Productsizes::$allFields as $classField) {
        ...
        $objects = Productsizes::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Productsizes::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Productsizes/SearchByField";
