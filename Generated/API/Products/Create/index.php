...
/*
        ...
        Sample call for API/Products/Create:

            API/Products/Create?ID...&Name...&Price...&Quantity...&ProductSizeID...&ProductTypeID...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: ID (int), Name (String), Price (), Quantity (int), ProductSizeID (int), ProductTypeID (int), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/Products.php");
        $object = new Products($_POST["ID"], $_POST["Name"], $_POST["Price"], $_POST["Quantity"], $_POST["ProductSizeID"], $_POST["ProductTypeID"]);
        $result = Products::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Products::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Products/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: ID (int), Name (String), Price (), Quantity (int), ProductSizeID (int), ProductTypeID (int), SessionID (String)";
	...
	if (!isset($_POST["ProductSizeID"]) || $_POST["ProductSizeID"] == "") die(json_encode($JSON_INVALID_PARAMS));
	if (!isset($_POST["ProductTypeID"]) || $_POST["ProductTypeID"] == "") die(json_encode($JSON_INVALID_PARAMS));
