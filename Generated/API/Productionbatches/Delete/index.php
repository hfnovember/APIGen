...
/*
        ...
        Sample call for API/Productionbatches/Delete:

            API/Productionbatches/Delete?ID...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        $objectID = $_POST["ID"];
        $result = Productionbatches::delete($objectID);
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Productionbatches/Delete";
