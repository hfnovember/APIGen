...
/*
        ...
        Sample call for API/_old_recipe/Create:

            API/_old_recipe/Create?Id...&Recipe_ingredients_id...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        $result = _old_recipe::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (_old_recipe::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_recipe/Create";
