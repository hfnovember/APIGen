...
/*
        ...
        Sample call for API/Producttypes/Delete:

            API/Producttypes/Delete?ID...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        $objectID = $_POST["ID"];
        $result = Producttypes::delete($objectID);
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Producttypes/Delete";
