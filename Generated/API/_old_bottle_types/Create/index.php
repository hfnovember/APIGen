...
/*
        ...
        Sample call for API/_old_bottle_types/Create:

            API/_old_bottle_types/Create?Id...&Bottle_quantity...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: Id (int), Bottle_quantity (int), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        $object = new _old_bottle_types($_POST["Id"], $_POST["Bottle_quantity"]);
        $result = _old_bottle_types::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (_old_bottle_types::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_bottle_types/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: Id (int), Bottle_quantity (int), SessionID (String)";
	...
	if (!isset($_POST["Bottle_quantity"]) || $_POST["Bottle_quantity"] == "") die(json_encode($JSON_INVALID_PARAMS));
