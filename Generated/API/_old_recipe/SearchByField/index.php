...
/*
        ...
        Sample call for API/_old_recipe/SearchByField:

            API/_old_recipe/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (_old_recipe::$allFields as $classField) {
        ...
        $objects = _old_recipe::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . _old_recipe::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_recipe/SearchByField";
