...
/*
        ...
        Sample call for API/Students/Create:

            API/Students/Create?Name...&Age...&Grade...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        $result = Students::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Students::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Students/Create";
