...
/*
        ...
        Sample call for API/Invoices/SearchByField:

            API/Invoices/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Invoices::$allFields as $classField) {
        ...
        $objects = Invoices::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Invoices::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Invoices/SearchByField";
