...
/*
        ...
        Sample call for API/_old_storage_type/Create:

            API/_old_storage_type/Create?Id...&Type_name...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: Id (int), Type_name (String), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        $object = new _old_storage_type($_POST["Id"], $_POST["Type_name"]);
        $result = _old_storage_type::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (_old_storage_type::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_storage_type/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: Id (int), Type_name (String), SessionID (String)";
