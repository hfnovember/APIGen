...
/*
        ...
        Sample call for API/Custom/Coffee

            API/Custom/Coffee/?Id...&Name...&Age...&SessionID=...

        /----------------------------------------------------------------/

        User Types/Levels who can access this endpoint:
         Administrator (1), Head Manager(5), Manager(2), User(3)
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: Id (Type), Name (Type), Age (Type), SessionID (String)"
    ...
    */
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Custom/Coffee";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: Id (Type), Name (Type), Age (Type), SessionID (String)";
    ...
    //Allowed user levels:
    $allowedUserLevelIDs = array(1, 5, 2, 3);
