...
/*
        ...
        Sample call for API/Productsizes/Create:

            API/Productsizes/Create?ID...&Name...&UnitTypeID...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/Productsizes.php");
        $object = new Productsizes($_POST["ID"], $_POST["Name"], $_POST["UnitTypeID"]);
        $result = Productsizes::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Productsizes::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Productsizes/Create";
