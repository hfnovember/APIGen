...
/*
        ...
        Sample call for API/_old_production/Create:

            API/_old_production/Create?Id...&Date...&Product_id...&Total_quantity...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: Id (int), Date (Date), Product_id (int), Total_quantity (int), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/_old_production.php");
        $object = new _old_production($_POST["Id"], $_POST["Date"], $_POST["Product_id"], $_POST["Total_quantity"]);
        $result = _old_production::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (_old_production::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_production/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: Id (int), Date (Date), Product_id (int), Total_quantity (int), SessionID (String)";
	...
	if (!isset($_POST["Date"]) || $_POST["Date"] == "") die(json_encode($JSON_INVALID_PARAMS));
	if (!isset($_POST["Product_id"]) || $_POST["Product_id"] == "") die(json_encode($JSON_INVALID_PARAMS));
	if (!isset($_POST["Total_quantity"]) || $_POST["Total_quantity"] == "") die(json_encode($JSON_INVALID_PARAMS));
