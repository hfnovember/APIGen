...
/*
        ...
        Sample call for API/Invoiceproducts/Delete:

            API/Invoiceproducts/Delete?ID...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        $objectID = $_POST["ID"];
        $result = Invoiceproducts::delete($objectID);
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Invoiceproducts/Delete";
