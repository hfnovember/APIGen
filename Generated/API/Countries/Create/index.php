...
/*
        ...
        Sample call for API/Countries/Create:

            API/Countries/Create?ID...&Name...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/Countries.php");
        $object = new Countries($_POST["ID"], $_POST["Name"]);
        $result = Countries::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Countries::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Countries/Create";
