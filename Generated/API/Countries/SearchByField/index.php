...
/*
        ...
        Sample call for API/Countries/SearchByField:

            API/Countries/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Countries::$allFields as $classField) {
        ...
        $objects = Countries::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Countries::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Countries/SearchByField";
