...
/*
        ...
        Sample call for API/Producttypes/Create:

            API/Producttypes/Create?ID...&Name...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        $result = Producttypes::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Producttypes::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Producttypes/Create";
