...
/*
        ...
        Sample call for API/Supplies/SearchByField:

            API/Supplies/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Supplies::$allFields as $classField) {
        ...
        $objects = Supplies::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Supplies::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Supplies/SearchByField";
