...
/*
        ...
        Sample call for API/Productsizes/Delete:

            API/Productsizes/Delete?ID...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        $objectID = $_POST["ID"];
        $result = Productsizes::delete($objectID);
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Productsizes/Delete";
