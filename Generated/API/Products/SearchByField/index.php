...
/*
        ...
        Sample call for API/Products/SearchByField:

            API/Products/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Products::$allFields as $classField) {
        ...
        $objects = Products::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Products::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Products/SearchByField";
