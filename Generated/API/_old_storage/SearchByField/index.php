...
/*
        ...
        Sample call for API/_old_storage/SearchByField:

            API/_old_storage/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (_old_storage::$allFields as $classField) {
        ...
        $objects = _old_storage::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . _old_storage::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_storage/SearchByField";
