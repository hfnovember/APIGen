...
/*
        ...
        Sample call for API/Defaultsizes/Delete:

            API/Defaultsizes/Delete?ID...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        $objectID = $_POST["ID"];
        $result = Defaultsizes::delete($objectID);
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Defaultsizes/Delete";
