...
/*
        ...
        Sample call for API/Defaultsizes/SearchByField:

            API/Defaultsizes/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Defaultsizes::$allFields as $classField) {
        ...
        $objects = Defaultsizes::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Defaultsizes::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Defaultsizes/SearchByField";
