...
/*
        ...
        Sample call for API/Supplies/Create:

            API/Supplies/Create?ID...&Name...&SupplierID...&Quantity...&Price...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: ID (int), Name (String), SupplierID (int), Quantity (int), Price (float), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/Supplies.php");
        $object = new Supplies($_POST["ID"], $_POST["Name"], $_POST["SupplierID"], $_POST["Quantity"], $_POST["Price"]);
        $result = Supplies::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Supplies::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Supplies/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: ID (int), Name (String), SupplierID (int), Quantity (int), Price (float), SessionID (String)";
	...
	if (!isset($_POST["SupplierID"]) || $_POST["SupplierID"] == "") die(json_encode($JSON_INVALID_PARAMS));
