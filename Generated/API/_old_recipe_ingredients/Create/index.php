...
/*
        ...
        Sample call for API/_old_recipe_ingredients/Create:

            API/_old_recipe_ingredients/Create?Id...&Recipe_id...&Ingredient_id...&Quantity_type_id...&Quantity...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: Id (int), Recipe_id (int), Ingredient_id (int), Quantity_type_id (int), Quantity (double), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/_old_recipe_ingredients.php");
        $object = new _old_recipe_ingredients($_POST["Id"], $_POST["Recipe_id"], $_POST["Ingredient_id"], $_POST["Quantity_type_id"], $_POST["Quantity"]);
        $result = _old_recipe_ingredients::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (_old_recipe_ingredients::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_recipe_ingredients/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: Id (int), Recipe_id (int), Ingredient_id (int), Quantity_type_id (int), Quantity (double), SessionID (String)";
	...
	if (!isset($_POST["Ingredient_id"]) || $_POST["Ingredient_id"] == "") die(json_encode($JSON_INVALID_PARAMS));
	if (!isset($_POST["Quantity_type_id"]) || $_POST["Quantity_type_id"] == "") die(json_encode($JSON_INVALID_PARAMS));
	if (!isset($_POST["Quantity"]) || $_POST["Quantity"] == "") die(json_encode($JSON_INVALID_PARAMS));
