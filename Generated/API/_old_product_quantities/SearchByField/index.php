...
/*
        ...
        Sample call for API/_old_product_quantities/SearchByField:

            API/_old_product_quantities/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (_old_product_quantities::$allFields as $classField) {
        ...
        $objects = _old_product_quantities::searchByFields($assocArray);
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_product_quantities/SearchByField";
