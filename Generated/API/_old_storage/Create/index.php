...
/*
        ...
        Sample call for API/_old_storage/Create:

            API/_old_storage/Create?Id...&Name...&Storage_type_id...&Quantity_type_id...&Quantity...&Price...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: Id (int), Name (String), Storage_type_id (int), Quantity_type_id (int), Quantity (double), Price (), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        $object = new _old_storage($_POST["Id"], $_POST["Name"], $_POST["Storage_type_id"], $_POST["Quantity_type_id"], $_POST["Quantity"], $_POST["Price"]);
        $result = _old_storage::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (_old_storage::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_storage/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: Id (int), Name (String), Storage_type_id (int), Quantity_type_id (int), Quantity (double), Price (), SessionID (String)";
	...
	if (!isset($_POST["Storage_type_id"]) || $_POST["Storage_type_id"] == "") die(json_encode($JSON_INVALID_PARAMS));
