...
/*
        ...
        Sample call for API/_old_quantity_type/Create:

            API/_old_quantity_type/Create?Id...&Type_name...&Abbreviation...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: Id (int), Type_name (String), Abbreviation (String), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/_old_quantity_type.php");
        $object = new _old_quantity_type($_POST["Id"], $_POST["Type_name"], $_POST["Abbreviation"]);
        $result = _old_quantity_type::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (_old_quantity_type::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_quantity_type/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: Id (int), Type_name (String), Abbreviation (String), SessionID (String)";
	...
	if (!isset($_POST["Type_name"]) || $_POST["Type_name"] == "") die(json_encode($JSON_INVALID_PARAMS));
	if (!isset($_POST["Abbreviation"]) || $_POST["Abbreviation"] == "") die(json_encode($JSON_INVALID_PARAMS));
