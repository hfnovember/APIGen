...
/*
        ...
        Sample call for API/Colors/Create:

            API/Colors/Create?Id...&Name...&Hex...
    ...
    */
    ...
    function onRequest() {
        ...
        $result = Colors::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Colors::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Colors/Create";
