...
/*
        ...
        Sample call for API/Productionbatches/Create:

            API/Productionbatches/Create?ID...&Quantity...&ProductID...&ProductionDate...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: ID (int), Quantity (int), ProductID (int), ProductionDate (Date), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        $object = new Productionbatches($_POST["ID"], $_POST["Quantity"], $_POST["ProductID"], $_POST["ProductionDate"]);
        $result = Productionbatches::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Productionbatches::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Productionbatches/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: ID (int), Quantity (int), ProductID (int), ProductionDate (Date), SessionID (String)";
	...
	if (!isset($_POST["ProductionDate"]) || $_POST["ProductionDate"] == "") die(json_encode($JSON_INVALID_PARAMS));
