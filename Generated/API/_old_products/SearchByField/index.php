...
/*
        ...
        Sample call for API/_old_products/SearchByField:

            API/_old_products/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (_old_products::$allFields as $classField) {
        ...
        $objects = _old_products::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . _old_products::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_products/SearchByField";
