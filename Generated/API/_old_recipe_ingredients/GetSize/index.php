...
/*
        ...
        Sample call for API/_old_recipe_ingredients/GetSize:

            API/_old_recipe_ingredients/GetSize?SessionID=...
...
;
        $result = _old_recipe_ingredients::getSize();
        if ($result !== false) {
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_recipe_ingredients/GetSize";
