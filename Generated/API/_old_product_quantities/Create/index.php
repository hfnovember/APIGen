...
/*
        ...
        Sample call for API/_old_product_quantities/Create:

            API/_old_product_quantities/Create?Id...&Production_id...&Bottle_type_id...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: Id (int), Production_id (int), Bottle_type_id (int), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        $object = new _old_product_quantities($_POST["Id"], $_POST["Production_id"], $_POST["Bottle_type_id"]);
        $result = _old_product_quantities::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (_old_product_quantities::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_product_quantities/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: Id (int), Production_id (int), Bottle_type_id (int), SessionID (String)";
	...
	if (!isset($_POST["Production_id"]) || $_POST["Production_id"] == "") die(json_encode($JSON_INVALID_PARAMS));
	if (!isset($_POST["Bottle_type_id"]) || $_POST["Bottle_type_id"] == "") die(json_encode($JSON_INVALID_PARAMS));
