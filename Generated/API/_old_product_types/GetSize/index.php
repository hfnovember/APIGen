...
/*
        ...
        Sample call for API/_old_product_types/GetSize:

            API/_old_product_types/GetSize?SessionID=...
...
;
        $result = _old_product_types::getSize();
        if ($result !== false) {
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_product_types/GetSize";
