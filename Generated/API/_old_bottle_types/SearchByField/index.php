...
/*
        ...
        Sample call for API/_old_bottle_types/SearchByField:

            API/_old_bottle_types/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (_old_bottle_types::$allFields as $classField) {
        ...
        $objects = _old_bottle_types::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . _old_bottle_types::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_bottle_types/SearchByField";
