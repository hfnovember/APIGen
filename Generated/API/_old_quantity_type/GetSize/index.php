...
/*
        ...
        Sample call for API/_old_quantity_type/GetSize:

            API/_old_quantity_type/GetSize?SessionID=...
...
;
        $result = _old_quantity_type::getSize();
        if ($result !== false) {
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_quantity_type/GetSize";
