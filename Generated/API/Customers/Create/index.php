...
/*
        ...
        Sample call for API/Customers/Create:

            API/Customers/Create?ID...&Name...&CountryID...&City...&Address...&Telephone...&ProductID...&SessionID=...
        ...
        2) Response ERROR
            ...
            --> "Message": "Invalid parameters. Expected Parameters: ID (int), Name (String), CountryID (int), City (String), Address (String), Telephone (String), ProductID (int), SessionID (String)"
    ...
    */
    ...
    function onRequest() {
        ...
        include_once("../../../Scripts/Entity Classes/PHP/Customers.php");
        $object = new Customers($_POST["ID"], $_POST["Name"], $_POST["CountryID"], $_POST["City"], $_POST["Address"], $_POST["Telephone"], $_POST["ProductID"]);
        $result = Customers::create($object);
        if ($result) die(json_encode($JSON_ADD_SUCCESS));
        else {
            if (Customers::$hasUniqueFields) die(json_encode($JSON_EXISTS_ERROR));
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Customers/Create";
    ...
    const INVALID_PARAMS_MESSAGE = "Invalid parameters. Expected Parameters: ID (int), Name (String), CountryID (int), City (String), Address (String), Telephone (String), ProductID (int), SessionID (String)";
	...
	if (!isset($_POST["ProductID"]) || $_POST["ProductID"] == "") die(json_encode($JSON_INVALID_PARAMS));
