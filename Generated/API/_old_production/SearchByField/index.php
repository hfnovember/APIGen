...
/*
        ...
        Sample call for API/_old_production/SearchByField:

            API/_old_production/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (_old_production::$allFields as $classField) {
        ...
        $objects = _old_production::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . _old_production::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/_old_production/SearchByField";
