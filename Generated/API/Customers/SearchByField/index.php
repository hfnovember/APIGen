...
/*
        ...
        Sample call for API/Customers/SearchByField:

            API/Customers/SearchByField?Fields=...Values=...&SessionID=...
    ...
    */
    ...
    function onRequest() {
        ...
        foreach ($fieldsArray as $field) {
            $exists = false;
            foreach (Customers::$allFields as $classField) {
        ...
        $objects = Customers::searchByFields($assocArray);
        ...
        $objectData = ", \"Data\": " . Customers::toJSONArray($objects) . "}";
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Customers/SearchByField";
