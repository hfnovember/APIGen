...
/*
        ...
        Sample call for API/Productionbatches/GetSize:

            API/Productionbatches/GetSize?SessionID=...
...
;
        $result = Productionbatches::getSize();
        if ($result !== false) {
    ...
    //Locals:
    const ENDPOINT_NAME = "API/Productionbatches/GetSize";
